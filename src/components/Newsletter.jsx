...
const Newsletter = () => {
  return (
    <section className='bg-newsletterOrange pt-10 pb-10'>
        <div className='siteContainer md:flex md:flex-row md:items-center md:justify-between'>
            ...
            <form action="" method='POST'>
                <div className='border-b-2'>
                    <input className='inputColor bg-newsletterOrange text-white opacity-70 outline-none w-60' type="email" name='email' placeholder='Drop your email here!' />
